  ...
  <footer dir='ltr' className="w-full bg-[#4A7B31]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
            ...
            <div className="grid grid-cols-12 gap-8 py-14 lg:grid-cols-8">
                ...
                <div className='text-3xl text-white font-bold'>الرواد لبناء القيم</div>
                    ...
                    <div className="flex mt-4 space-x-4 justify-center lg:justify-start sm:mt-0 ">
                        ...
                        <a href="/"  className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center   
                        ">
                ...
                <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
                    <h4 className="text-lg text-white font-medium mb-7">ابقى على تواصل</h4>
                    <ul className="text-white   transition-all duration-500">
                        <li className="mb-6 flex items-center gap-5"><MdOutlineEmail />info@Value.sa</li>
                        <li className="mb-6 flex items-center  gap-3"><MdOutlineLocalPhone /> + 966 11 207 1607</li>
                        <li className='mb-6 flex items-center  gap-3' > <CiLocationOn /> Value, P.O.Box 4054- Riyadh 12464</li>
                    </ul>
                </div>
                ...
                <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:order-last sm:col-span-4 md:col-span-4 lg:order-none lg:col-span-1">
                    <h4 className="text-lg text-white font-medium mb-7">المنتجات</h4>
                    <ul className="text-white  transition-all duration-500  ">
                        <li className="mb-6"><a href="/"  className="text-white  hover:text-white">الرئيسية</a></li>
                        <li className="mb-6"><a href="/"  className="text-white  hover:text-white">من نحن</a></li>
                        <li className="mb-6"><a href="/"  className=" text-white  hover:text-white">الخدمات</a></li>
                        <li className="mb-6"><a href="/"  className=" text-white  hover:text-white">المرصد</a></li>
                        <li className="sm:mb-6"><a href="/"  className=" text-white  hover:text-white">المنتجات</a></li>
                    </ul>
                </div>
             
                <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
                    <h4 className="text-lg text-center text-white font-medium mb-7 lg:text-left">النشرة الإخبارية</h4>
                    <div className="flex flex-col items-center lg:items-start">
                        <input type="text" className="w-full h-12 border border-gray-300 rounded-full py-2.5 px-5 shadow-sm text-text-white mb-5 text-center lg:text-left placeholder:text-gray-400 focus:outline-none focus:border-gray-500"  placeholder="...ادخل الايميل الخاص بك "/>
                        <button type="submit" className="h-11 py-3 px-6 bg-[#6b996b] transition-all border-white border  duration-500 shadow-md rounded-full text-sm text-white font-semibold w-fit hover:scale-[1.02]">إشترك اﻷن</button>
                    </div>
                </div>
            ...
            <div className="py-7 border-t border-gray-200">
                ...
                <ul className="flex items-center mt-4  gap-1 lg:mt-0  text-white "><a href='https://www.alrowadit.com/ ' target='_blank'><span className='underline'> بدعم من الرواد</span></a>
                    </ul>
                    <span className="text-sm text-white ">©2024 ,جميع الحقوق محفوظة</span>
